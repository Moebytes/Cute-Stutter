...
public:
    ...
    static auto loadFromJSON() -> ParameterIDs {
        ...
        parameterIDs.rate = getParameter("rate");
        parameterIDs.hold = getParameter("hold");
        parameterIDs.length = getParameter("length");
        parameterIDs.reverse = getParameter("reverse");
